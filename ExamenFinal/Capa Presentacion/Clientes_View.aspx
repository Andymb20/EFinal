...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False">
    <Columns>
        <asp:BoundField DataField="cliente_id" HeaderText="ID Cliente" />
        <asp:BoundField DataField="cliente_nombre" HeaderText="Nombre" />
        <asp:BoundField DataField="cliente_email" HeaderText="Email" />
        <asp:BoundField DataField="cliente_telefono" HeaderText="Teléfono" />
    </Columns>
</asp:GridView>
