...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False">
    <Columns>
        <asp:BoundField DataField="agente_id" HeaderText="ID" />
        <asp:BoundField DataField="agente_nombre" HeaderText="Nombre" />
        <asp:BoundField DataField="agente_email" HeaderText="Email" />
        <asp:BoundField DataField="agente_telefono" HeaderText="Telefono" />
    </Columns>
</asp:GridView>
